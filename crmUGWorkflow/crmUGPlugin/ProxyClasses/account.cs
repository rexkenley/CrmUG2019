...
namespace crmUGPlugin.ProxyClasses
{
    ...
    public partial class account : BaseProxyClass
    {
        ...
        /// <summary>
        /// <para>Logical Name: vm_accountid</para>
        /// <para>Max Length: 50 characters</para>
        /// </summary>
        [AttributeLogicalName("vm_accountid")]
        public string vm_accountid
        {
            get
            {
                return this.GetPropertyValue<string>("vm_accountid");
            }
            set
            {
                this.SetPropertyValue("vm_accountid", value, 50, "vm_accountid");
            }
        }
        ...
        /// <summary>
        /// <para><b>Entity (Customer)</b></para>
        /// <para>Schema Name: incident_customer_accounts</para>
        /// </summary>
        public List<Entity> Getincident_customer_accounts(IOrganizationService service, params string[] columns) { return BaseProxyClass.GetRelatedOneToManyEntities(service, this.Id, "incident", "customerid", columns); }

        /// <summary>
        /// <para><b>Entity (Customer)</b></para>
        /// <para>Schema Name: incident_customer_accounts</para>
        /// </summary>
        public List<Entity> Getincident_customer_accounts(IOrganizationService service, ColumnSet columns) { return BaseProxyClass.GetRelatedOneToManyEntities(service, this.Id, "incident", "customerid", columns); }
        ...
        public static class Properties
        {
            ...
            /// <para>Logical Name = vm_accountid</para>
            /// </summary>
            public const string vm_accountid = "vm_accountid";
